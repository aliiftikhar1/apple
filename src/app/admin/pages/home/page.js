...
export default function Home() {
  ...
  const fetchData = async (type) => {
    try {
      let endpoint = '';
      if (type === 'users') {
        endpoint = 'https://apple-immi-solution.vercel.app/api/admin';
      } else if (type === 'customer') {
        endpoint = 'https://apple-immi-solution.vercel.app/api/user';
      } else if (type === 'branches') {
        endpoint = 'https://apple-immi-solution.vercel.app/api/branches';
      } else if (type === 'filetypes') {
        endpoint = 'https://apple-immi-solution.vercel.app/api/filetype';
      }
