...
console.log(data)
  const handleAddOrUpdateItem = async () => {
    setIsLoading(true);
    const url = newItem.id ? `https://apple-immi-solution.vercel.app/api/branches/${newItem.id}` : 'https://apple-immi-solution.vercel.app/api/branches'; // Use the ID to determine the URL
  ...
  const handleDeleteItem = async (id) => {
    setIsLoading(true);
    try {
      await fetch(`https://apple-immi-solution.vercel.app/api/branches/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
